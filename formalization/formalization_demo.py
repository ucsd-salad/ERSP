...
from controlled_english_translator import translate_slice
import argparse
import os
import random
import re
...
if __name__ == "__main__":
    ...
    while True:
        ...
        while reviewing:
            ...
            print("=" * 70)
            print(current_snippet.rstrip())

            print("\n" + "-" * 22 + " Controlled English Translation " + "-" * 22)
            try:
                translation = translate_slice(current_snippet)
